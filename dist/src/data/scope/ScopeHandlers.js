...
const ScopeController_1 = __importDefault(require("./ScopeController"));
...
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const scopes = yield ScopeController_1.default.create(data);
        return {
...
//# sourceMappingURL=ScopeHandlers.js.map