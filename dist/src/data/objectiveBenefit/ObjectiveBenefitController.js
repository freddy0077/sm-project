...
const ObjectiveBenefitData_1 = __importDefault(require("./ObjectiveBenefitData"));
...
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const benefits = yield ObjectiveBenefitData_1.default.create(data);
        return {
...
//# sourceMappingURL=ObjectiveBenefitController.js.map