...
const ObjectiveBenefitController_1 = __importDefault(require("./ObjectiveBenefitController"));
...
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const benefits = yield ObjectiveBenefitController_1.default.create(data);
        return {
...
//# sourceMappingURL=ObjectiveBenefitHandlers.js.map