...
exports.create = exports.deleteDepartment = exports.update = exports.insert = exports.getAll = exports.get = void 0;
...
const insert = (departments) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield departments().insert(input, ['id', "name"]))[0];
});
...
const update = (departments) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (yield departments().where({ id }).update(updateFields, ['id', 'name']))[0];
});
exports.update = update;
const deleteDepartment = (departments) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = input;
    if (!id) {
        throw new Error("An ID must be provided to delete a department.");
    }
    return yield departments().where({ id }).del();
});
exports.deleteDepartment = deleteDepartment;
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const departments = () => data.postgres.withSchema(config_1.Database.schema).table('Department');
        return {
...
//# sourceMappingURL=DepartmentData.js.map