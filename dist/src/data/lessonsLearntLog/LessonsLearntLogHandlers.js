...
const LessonLearntLogController_1 = __importDefault(require("./LessonLearntLogController"));
...
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const lessons = yield LessonLearntLogController_1.default.create(data);
        return {
...
//# sourceMappingURL=LessonsLearntLogHandlers.js.map