...
const deleteScope = (query) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = input;
    if (!id) {
...
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const scopes = () => data.postgres.withSchema(config_1.Database.schema).table('DecisionRegister');
        return {
...
//# sourceMappingURL=DecisionRegisterData.js.map