...
exports.create = exports.deleteObjective = exports.update = exports.insert = exports.getAll = exports.get = void 0;
...
const insert = (objectives) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield objectives().insert(input, ['id']))[0];
});
...
const update = (objectives) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (yield objectives().where({ id }).update(updateFields, ['id']))[0];
});
...
const deleteObjective = (objectives) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield objectives().where({ id }).del();
});
exports.deleteObjective = deleteObjective;
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const objectives = () => data.postgres.withSchema(config_1.Database.schema).table('Objective');
        return {
...
//# sourceMappingURL=ObjectiveData.js.map